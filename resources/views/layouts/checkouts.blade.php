            ...
            <div class="col-lg-9 col-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{ route('checkouts.store', $camp->id) }}" class="basic-form" method="POST">
                            @csrf
                            <div class="mb-4">
                            ...
                            <div class="mb-5">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input name="expired" type="month" class="form-control {{ $errors->has('expired') ? 'is-invalid' : '' }}" value="{{ old('expired') ?: Auth::user()->expired }}"/>
 required                                        @if ($errors->has('expired'))
                                        <p class="text-danger">{{ $errors->first('expired') }}</p>
                                        @endif
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <label class="form-label">CVC</label>
                                        <input name="cvc" type="number" maxlength="3" class="form-control {{ $errors->has('cvc') ? 'is-invalid' : '' }}" value="{{ old('cvc') ?: Auth::user()->cvc }}"/>
     required                                    @if ($errors->has('cvc'))
